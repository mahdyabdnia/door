        ...
        <div class="main2">
            ...
            <form >
                ...
                <input type="text" class="form-control form-input" id="name" placeholder="لطفا نام محصول را وارد نمایید">
                ...
                <input type="text" class="form-control form-input" id="name" placeholder="لطفا نام برند را وارد نمایید">
                ...
                <label align="right">مشخصات محصول</label>
                    <textarea  class="form-control form-input" placeholder="لطفا مشخصات محصول را وارد نمایید"></textarea>
                </div>
